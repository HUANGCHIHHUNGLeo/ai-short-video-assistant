...
2. ⚠️ 內容必須有價值！有乾貨！要有具體的數字、案例、方法！
3. ⚠️ 像正常台灣人說話！禁止大陸用語（你猜怎麼著、咋了、牛逼、整活等）
4. 開頭 3 秒要能 HOOK 住觀眾（禁止用「大家好」「今天要來分享」開場）
5. 每個版本要有足夠的 segments 來填滿 ${duration} 秒
6. 每段的 voiceover 都要夠長、夠詳細，不能只有一兩句話就結束！
7. 每段都要有具體的：畫面描述、口播內容、字卡、特效、音效
8. ⚠️ 最終驗證：把所有 voiceover 字數加總，確保達到 ${min}-${max} 字
9. ⚠️ 台灣語氣詞：真假、不會吧、誇張欸、傻眼、扯、靠、天啊、其實、說真的、重點是
...
### 正確的寫法（要這樣！）：
- ✅ 有具體細節：「那時候我欠了四百萬，每天睡覺前都在算還要還多久」
- ✅ 有因果邏輯：「後來我改了一件事：每天打 50 通電話。第一個月成交 3 個，第二個月 8 個」
- ✅ 像在聊天：「說真的，我一開始也不信。但你看看這個數字...」
- ✅ 有 insight：「一般人以為 XXX，其實真正的關鍵是 YYY」`
