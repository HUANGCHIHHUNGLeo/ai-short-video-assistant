...
## 輸出格式（JSON）
{
  "ideas": [
    {
      "title": "選題方向（描述這個選題的核心概念，不是爆款標題，而是引導方向，20-40字）",
      "type": "選題類型",
      "description": "為什麼這個方向值得做？目標受眾會有什麼反應？（50-80字）",
      "targetAudience": "目標受眾（具體人群）",
      "hookSuggestion": "開頭引導（給一個開頭的思路方向，用戶可以自行調整成適合自己風格的版本）",
      "contentOutline": ["可以講的點1", "可以講的點2", "可以講的點3"],
      "platformTips": "平台發布建議",
...
## 極重要：選題是引導方向，不是直接給爆款標題！

title 欄位要給的是「選題方向」，不是完整的爆款標題。
...
✅ 正確示範（給引導方向）：
- "探討存錢困難的心理障礙，從小習慣改變開始"
- "分享薪水不高但成功理財的真實經驗，強調可複製性"
- "打破傳統省錢觀念，講解主動收入 vs 被動收入的差異"

原因：用戶會根據自己的風格、經歷、受眾來調整成適合自己的標題，我們只需要給方向。

## 重要原則
- 選題要具體，指出可以講什麼內容
- 方向要明確，讓用戶知道這支影片要傳達什麼核心訊息
- 每個選題都要考慮目標受眾的痛點
- 給出 3 個不同類型的選題供選擇
